...
INSERT INTO `category` VALUES ('7', '护肤');
...
CREATE TABLE `categorysecond` (
  ...
  KEY `FK936FCAF21DB1FD15` (`cid`) USING BTREE,
...
CREATE TABLE `orderitem` (
  ...
  KEY `FKE8B2AB6166C01961` (`oid`) USING BTREE,
  KEY `FKE8B2AB6171DB7AE4` (`pid`) USING BTREE,
  KEY `FKE8B2AB6140ACF87A` (`oid`) USING BTREE,
  KEY `FKfurmkgubmx06qm31x90spl4mu` (`uid`) USING BTREE,
  CONSTRAINT `FKE8B2AB6140ACF87A` FOREIGN KEY (`oid`) REFERENCES `orders` (`oid`),
  CONSTRAINT `FKE8B2AB6171DB7AE4` FOREIGN KEY (`pid`) REFERENCES `product` (`pid`),
  CONSTRAINT `FKfurmkgubmx06qm31x90spl4mu` FOREIGN KEY (`uid`) REFERENCES `orders` (`oid`)
) ENGINE=InnoDB AUTO_INCREMENT=26 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;

-- ----------------------------
-- Records of orderitem
-- ----------------------------
INSERT INTO `orderitem` VALUES ('17', '1', '228', '1', '9004', '9004');
INSERT INTO `orderitem` VALUES ('18', '1', '358', '51', '9005', '9005');
INSERT INTO `orderitem` VALUES ('19', '1', '119', '6', '9005', '9005');
INSERT INTO `orderitem` VALUES ('20', '1', '358', '51', '9006', '9006');
INSERT INTO `orderitem` VALUES ('21', '1', '119', '6', '9006', '9006');
INSERT INTO `orderitem` VALUES ('22', '2', '166', '68', '9007', '9007');
INSERT INTO `orderitem` VALUES ('23', '1', '358', '51', '9008', '9008');
INSERT INTO `orderitem` VALUES ('24', '1', '358', '51', '9009', '9009');
INSERT INTO `orderitem` VALUES ('25', '1', '299', '60', '9010', '9010');
...
CREATE TABLE `orders` (
  ...
  KEY `FKC3DF62E5AA3D9C7` (`uid`) USING BTREE,
  CONSTRAINT `FKC3DF62E5AA3D9C7` FOREIGN KEY (`uid`) REFERENCES `user` (`uid`)
) ENGINE=InnoDB AUTO_INCREMENT=9011 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;

-- ----------------------------
-- Records of orders
-- ----------------------------
INSERT INTO `orders` VALUES ('9004', '228', '2019-06-06 11:41:18', '1', null, null, null, '19');
INSERT INTO `orders` VALUES ('9005', '477', '2019-06-06 12:12:43', '1', null, null, null, '19');
INSERT INTO `orders` VALUES ('9006', '477', '2019-06-06 12:14:21', '1', null, null, null, '19');
INSERT INTO `orders` VALUES ('9007', '166', '2019-08-23 08:56:37', '1', null, null, null, '19');
INSERT INTO `orders` VALUES ('9008', '358', '2019-08-23 08:56:50', '1', null, null, null, '19');
INSERT INTO `orders` VALUES ('9009', '358', '2019-08-23 09:14:55', '1', null, null, null, '19');
INSERT INTO `orders` VALUES ('9010', '299', '2019-08-23 09:15:17', '1', null, null, null, '19');
...
CREATE TABLE `product` (
  ...
  KEY `FKED8DCCEFB9B74E02` (`csid`) USING BTREE,
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES ('19', 'aaa', 'aaa', 'cat', 'aaa@shop.com', '1234567889', '广东', '1', null);
INSERT INTO `user` VALUES ('20', 'bbb', 'bbb', 'dog', 'bbb@shop.com', '13397727953', 'USA', '0', '967e45ae87d44132ab6785e67975dcb6d28a2eccfa304aa7924c8561eb0abfe2');
